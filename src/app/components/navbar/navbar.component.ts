  ...
  template: `
      ...
      <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <a
            ...
            class="text-2xl font-black bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent"
          >
            MyShop
          </a>
          ...
          >
            ...
            <span
              *ngIf="cartItemCount$ | async as count"
              class="absolute -top-2 -right-3 bg-blue-600 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center"
            >
              {{ count }}
            </span>
          </a>
    ...
    <aside class="fixed left-0 top-16 h-full w-64 bg-white border-r-2 border-gray-200 pt-6 z-40">
      <nav class="flex flex-col gap-2 px-4">
        <a
          routerLink="/shop/products"
          routerLinkActive="bg-cyan-50 text-cyan-600 font-bold"
        ...
        <a
          ...
          routerLinkActive="bg-pink-50 text-pink-600 font-bold"
