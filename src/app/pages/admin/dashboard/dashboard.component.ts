      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div *ngIf="stats$ | async as stats">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div
              class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg relative overflow-hidden hover:border-green-300 transition-all"
            >
              <div
                class="absolute top-0 right-0 w-32 h-32 bg-green-400 opacity-5 rounded-full -mr-16 -mt-16"
              ></div>
              <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                  <h3 class="text-gray-600 text-sm font-bold uppercase tracking-wider">
                    Utilisateurs
                  </h3>
                  <span class="text-3xl">👥</span>
                </div>
                <p
                  class="text-5xl font-black bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent"
                >
                  {{ stats.totalUsers }}
                </p>
              </div>
            ...
            <div
              class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg relative overflow-hidden hover:border-blue-300 transition-all"
            >
              <div
                class="absolute top-0 right-0 w-32 h-32 bg-blue-400 opacity-5 rounded-full -mr-16 -mt-16"
              ></div>
              <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                  <h3 class="text-gray-600 text-sm font-bold uppercase tracking-wider">
                ...
                <p
                  class="text-5xl font-black bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent"
                >
                  {{ stats.totalOrders }}
                </p>
              </div>
            ...
            <div
              class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg relative overflow-hidden hover:border-yellow-300 transition-all"
            >
              <div
                class="absolute top-0 right-0 w-32 h-32 bg-yellow-400 opacity-5 rounded-full -mr-16 -mt-16"
              ></div>
              <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                  <h3 class="text-gray-600 text-sm font-bold uppercase tracking-wider">
                ...
                <p
                  class="text-4xl font-black bg-gradient-to-r from-yellow-500 to-orange-500 bg-clip-text text-transparent"
                >
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 shadow">
              ...
              <div class="space-y-4">
                <div
                  *ngFor="
                    let product of stats.topProducts;
                    let i = index;
                ...
                >
                  <div
                    class="w-10 h-10 bg-gradient-to-br from-green-400 to-emerald-500 rounded-lg flex items-center justify-center font-black text-white text-lg shadow-md"
                  >
                    {{ i + 1 }}
                  </div>
                  <div class="flex-1">
