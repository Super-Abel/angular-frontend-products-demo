    ...
    <div class="min-h-screen bg-gray-50 p-8">
      <div class="max-w-4xl mx-auto">
        ...
        <div *ngIf="user$ | async as user" class="space-y-6">
          <!-- User Card -->
          <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg relative overflow-hidden">
            <div class="absolute top-0 right-0 w-64 h-64 bg-cyan-400 opacity-5 rounded-full -mr-32 -mt-32"></div>

            <div class="flex items-start gap-6 relative z-10">
              <div class="w-24 h-24 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center text-4xl font-black text-white">
                {{ user.fullName?.charAt(0) || 'U' }}
              </div>

              <div class="flex-1">
                <h2 class="text-2xl font-bold mb-1 text-gray-900">{{ user.fullName || 'Utilisateur' }}</h2>
                ...
                <div class="flex gap-4">
                  ...
                  <div class="px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p class="text-xl font-bold text-blue-600">{{ user.wishlistProductIds.length || 0 }}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="bg-white border-2 border-gray-200 rounded-xl p-6 shadow">
            ...
            <div class="space-y-6">
              <label class="flex items-center gap-3 p-4 bg-gray-50 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-cyan-300 hover:bg-cyan-50 transition-all">
                <input
                  type="checkbox"
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Note minimum par défaut</label>
                <select
